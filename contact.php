...
<body>
        ...
        <div class="container text-center">
            ...
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    ...
                    <li class="breadcrumb-item"><a class="text-white" href="category.php">Categoty</a></li>
    ...
    <p class="US">If You Have Any Problem, <br>Please Contact Us!</p>
    <div class="form">
        <h5 class="cont"> Contact Us</h5>
           ...
           <input type="text" id="name" name="name" ><br><br>
               <label for="email">Your Email:</label>
                   <input type="email" id="email" name="email" ><br><br>
                    ...
                    <button class="sub" type="submit" name="submit" onclick="alert('Button clicked!')">submit</button>
            </form>
    </div>
</div>
